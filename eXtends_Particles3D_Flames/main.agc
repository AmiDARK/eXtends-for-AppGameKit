...
REM We check if DBProBasic3DExtends.dll is correctly initialized
  ...
  Particle1 = P3D_AddParticles( 24, 0, 64 )
  P3D_PositionParticles( Particle1, 64, 100, 0 )
  P3D_SetEmitterRange( Particle1, 80, 200, 80 )
  P3D_SetAsFlames( Particle1 )
  Particle2 = P3D_AddParticles( 24, 0, 64 )
  P3D_PositionParticles( Particle2, -64, 100, 0 )
  P3D_SetEmitterRange( Particle2, 80, 200, 80 )
  P3D_SetAsFlames( Particle2 )
  Particle3 = P3D_AddParticles( 24, 0, 64 )
  P3D_PositionParticles( Particle3, 0, 100, 64 )
  P3D_SetEmitterRange( Particle3, 80, 200, 80 )
  P3D_SetAsFlames( Particle3 )
  Particle4 = P3D_AddParticles( 24, 0, 64 )
  P3D_PositionParticles( Particle4, 0, 100, -64 )
  P3D_SetEmitterRange( Particle4, 80, 200, 80 )
  P3D_SetAsFlames( Particle4 )
